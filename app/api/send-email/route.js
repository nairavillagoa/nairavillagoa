  ...
  if (payload.operation === "homeContact") {
    try {
      ...
      await transporter.sendMail({
        ...
        subject: 'You received an enquiry from Naira Villa Goa',
        html: `
    ...
    try {
      ...
      await transporter.sendMail({
        from: process.env.EMAIL_USER,
        to: process.env.EMAIL_USER,
        subject: 'You received an job enquiry from Naira Villa Goa',
        html: `
          <h2>Contact Form Details</h2>
          <ul>
            <li><strong>Full Name:</strong> ${payload.formValues.fullName}</li>
    ...
    try {
      ...
      await transporter.sendMail({
        from: process.env.EMAIL_USER,
        to: process.env.EMAIL_USER,
        subject: 'You received an service enquiry from Naira Villa Goa',
        html: `
          <h2>Contact Form Details</h2>
          <ul>
