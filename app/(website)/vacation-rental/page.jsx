  ...
  const websitedata = [
    {
      ...
      "description": "At Naira Villa Goa, We offer end-to-end vacation rental management services, including property listing, marketing, guest handling, maintenance, and maximizing your property's income potential."
    }
  ]
