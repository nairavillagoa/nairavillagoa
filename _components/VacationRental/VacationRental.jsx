  ...
  return (
    ...
    <div className="flex flex-col justify-center items-center lg:w-[80%] w-[90%] gap-16">
      ...
      <div className="mt-4 text-center relative">
        ...
        Property Management Services by Naira Villa Goa: Turn Your Property into Profit
        </h2>
        <div className="grid grid-cols-1 gap-0 mt-4">
          <p className="text-base sm:text-lg mt-4 font-normal text-gray-500 text-justify">
          Are you a property owner looking to increase your income? If your property isn’t generating enough revenue, Naira Villa Goa can help transform it into a profitable venture. We specialize in turning properties like villas, farmhouses, and barns into successful rental businesses.
          </p>
        </div>
      </div>
