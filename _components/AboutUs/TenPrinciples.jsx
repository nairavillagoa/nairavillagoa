...
const TenPrinciples = () => {
    ...
    const cards = [
        ...
        },
        {
          title: "Fair Pricing",
          description:
            "At Naira Villa Goa, we provide competitive pricing with no hidden fees. Our transparent cost structure ensures you get the best value for your investment.",
          color: "to-gray-800",
          textColor: "text-gray-800",
          icon: (<>
                        ...
                        <div className="w-full lg:w-[50%] flex flex-col items-center h-full">
                            ...
                            <div className="flex flex-col gap-10 h-full">
                                ...
                                <p className="text-base lg:text-lg text-gray-600 w-full lg:w-[70%] mb-0 lg:mb-12 xl:mb-16">
                                    ...
                                    our workplace, as Naira Villa Goa team members, we practice certain
