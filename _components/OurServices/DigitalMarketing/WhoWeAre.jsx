...
const OurProcessData = [
    ...
    },
    {
        ...
        detail1: "At Naira Villa Goa, we focus on aligning our digital marketing expertise with your business goals to drive sustainable growth for your hotel. Whether your aim is to increase direct bookings, enhance brand visibility, boost occupancy rates, or build long-term guest loyalty, we design strategies tailored to your unique needs.",
