        ...
        <div className='hidden md:flex md:flex-col gap-12'>
          ...
          <div className="grid grid-cols-3">
            <div className='flex flex-col col-span-2 gap-2 text-gray-700'>
              ...
              <p>
                Naira Villa Goa help hotels to make their own brand by staying at the backend and bringing hotel brand in the front by delivering exceptional services which a hotel needs to build their own brand. So why tie up with hotel chains or any company who promises you to generate revenue for you through their brand.
                Build your own brand through Naira Villa Goa.
              </p>
            </div>
          ...
          <div className="grid grid-cols-3">
            <div className='flex flex-col col-span-2 gap-2 text-gray-700'>
              ...
              <p>
                As millennials are fast moving to the social media channels, hotels can’t afford to miss this opportunity to market their brand on these channels. We also find that a large chunk of the hotels has little or no idea about social media. You will be surprised to know most of your bookings could come from these social media channels. Helmed by social media professionals with years of experience in managing online brand presence at the best hotel marketing company in Mumbai, Naira Villa Goa can help you create and manage organic and paid social media campaigns across channels.
              </p>
