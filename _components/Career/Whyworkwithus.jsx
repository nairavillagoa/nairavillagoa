...
const Whyworkwithus = () => {
    ...
    const cardData = [
        ...
        },
        {
            ...
            description: "At Naira Villa Goa, we encourage you to think outside the box and bring new ideas to life. Innovation is at the heart of everything we do.",
        ...
        <div className="w-full flex justify-center items-center mt-16">
            <div className="flex flex-col justify-center items-center lg:w-[80%] w-[90%] gap-16">
                ...
                <div className="flex flex-col gap-4 justify-center items-center w-full bg-slate-100 p-8">
                    ...
                    At Naira Villa Goa, we believe that our success is driven by the people who work with us. We offer an environment where your passion and creativity can thrive, and we are committed to fostering growth, inclusion, and impact. Here’s why you should consider joining our team:
                    </p>
