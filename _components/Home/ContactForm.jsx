                ...
                <div className='w-full md:w-[60%] px-4 md:px-8 py-8 md:py-16'>
                    <form className='flex flex-col gap-7' onSubmit={handleSubmit}>
                        ...
                        <div className='mt-4 text-gray-500 opacity-80 text-sm md:text-base'>
                            By submitting your details, you confirm that you would like to receive marketing emails from Naira Villa Goa and you agree to the storing and processing of your personal data by Naira Villa Goa as described in our privacy policy.
                        </div>
                        <button
                            type='submit'
