  ...
  return (
    <div className="relative w-full h-[40vh] md:h-[45vh] lg:h-[60vh] min-h-screen flex justify-center items-center">
      ...
      <div className="w-full h-[70vh] md:h-[80vh] lg:h-[90vh] py-10 lg:p-0 flex flex-col justify-center items-center absolute z-10">
        ...
        <div className="w-full flex justify-center items-center mt-6 lg:mt-10">
          <Button radius="full" className="bg-white text-black font-bold px-8 rounded-none text-xs sm:text-sm md:text-base" style={{ letterSpacing: '0.1em' }} onClick={() => handleOpen()}>
            BOOK NOW
          </Button>
        </div>
