        ...
        <div className="relative w-full h-[40vh] md:h-[45vh] lg:h-[60vh] min-h-screen flex justify-center items-center">
            ...
            <div className="w-full h-[70vh] md:h-[80vh] lg:h-[90vh] py-10 lg:p-0 flex flex-col justify-center items-center absolute z-10 gap-14">
                ...
                <div className="w-full flex justify-center items-center mt-8">
                    <h1 className="text-white text-5xl sm:text-6xl md:text-5xl" style={{ fontFamily: '"Playfair Display", serif' }}>
                        Facilities You Get
                    </h1>
                </div>
                <div className="relative w-full lg:w-[80%] flex justify-center items-center h-[100%] flex-col">
                    ...
                    <div className="flex flex-col gap-4 md:gap-8 lg:gap-3 justify-start items-start w-full h-full">
                        ...
                        {/* ICONS */}
                        <div className="grid grid-cols-5 justify-evenly items-center w-full text-white text-opacity-80 gap-12">
