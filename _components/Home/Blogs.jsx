...
<div className="hidden relative w-full h-[40vh] md:h-[45vh] lg:h-[60vh] min-h-screen lg:flex justify-center items-center">
        ...
        <div className="lg:hidden relative w-full h-[40vh] md:h-[45vh] lg:h-[60vh] min-h-screen flex justify-center items-center">
            {/* Background Image */}
            <img
                src={IMAGES["59"]}
                alt="landing-bg"
            ...
            <div className="w-full h-[70vh] md:h-[80vh] lg:h-[90vh] py-10 lg:p-0 flex flex-col justify-center items-center absolute z-10 gap-14">
                ...
                <div className="relative w-full lg:w-[80%] flex justify-center items-center h-[100%] flex-col">
                    ...
                    <div className="flex flex-col gap-4 md:gap-8 lg:gap-3 justify-start items-start w-full h-full">
                        ...
                        {/* ICONS */}
                        <div className="grid grid-cols-3 justify-evenly items-center w-full text-white text-opacity-80 gap-2">
                            <div className='flex flex-col justify-center items-center'>
                                <div>
                                    <AirVent className='self-center size-8' />
                                </div>
                                <div>
                                    <span className="text-xs font-semibold self-center">Air Conditioner</span>
                                </div>
                            </div>
                            <div className='flex flex-col justify-center items-center'>
                                <div>
                            ...
                            <div className='flex flex-col justify-center items-center'>
                                ...
                                <div>
                                    <span className="text-xs font-medium self-center">Inverter Power Backup</span>
                                </div>
                            </div>
                            <div className='flex flex-col justify-center items-center'>
                                <div>
                            ...
                            <div className='flex flex-col justify-center items-center'>
                                ...
                                <div>
                                    <span className="text-xs font-medium self-center">Laundry at Extra Charge</span>
                                </div>
                            </div>
                            <div className='flex flex-col justify-center items-center'>
                                <div>
                                ...
                                <div>
                                    <span className="text-xs font-medium self-center">Housekeeping Team</span>
                                </div>
                            </div>
                            <div className='flex flex-col justify-center items-center'>
                                <div>
                                ...
                                <div>
                                    <span className="text-xs font-medium self-center">Caretaker Assistance</span>
                                </div>
                            </div>
                            <div className='flex flex-col justify-center items-center'>
                                <div>
                                ...
                                <div>
                                    <span className="text-xs font-medium self-center">Car & Bike Rental At Extra Pay</span>
                                </div>
                            </div>
                            <div className='flex flex-col justify-center items-center'>
                                <div>
                                ...
                                <div>
                                    <span className="text-xs font-medium self-center">Breakfast at 300 Per Plate</span>
                                </div>
                            </div>
                            <div className='flex flex-col justify-center items-center'>
                                <div>
                                ...
                                <div>
                                    <span className="text-xs font-medium self-center">Private Parking</span>
                                </div>
                            </div>
                            <div className='flex flex-col justify-center items-center'>
                                <div>
                                ...
                                <div>
                                    <span className="text-xs font-medium self-center">Balconies</span>
                                </div>
                            </div>
                            <div className='flex flex-col justify-center items-center'>
                                <div>
                                ...
                                <div>
                                    <span className="text-xs font-medium self-center">Refrigerator</span>
                                </div>
                            </div>
                            <div className='flex flex-col justify-center items-center'>
                                <div>
                            ...
                            <div className='flex flex-col justify-center items-center'>
                                ...
                                <div>
                                    <span className="text-xs font-medium self-center">Toiletries</span>
                                </div>
                            </div>
                            <div className='flex flex-col justify-center items-center'>
                                <div>
                            ...
                            <div className='flex flex-col justify-center items-center'>
                                ...
                                <div>
                                    <span className="text-xs font-medium self-center">03 AC Bedrooms</span>
                                </div>
                            </div>
                            <div className='flex flex-col justify-center items-center'>
                                <div>
                                ...
                                <div>
                                    <span className="text-xs font-medium self-center text-center">02 AC Living Room</span>
                                </div>
                            </div>
